...
namespace AppEL.Services
{
    public class JsonFileService
    {
        ...
        private readonly string _enrollmentDataPath;
        ...
        public JsonFileService(IWebHostEnvironment webHostEnvironment)
        {
            ...
            _enrollmentDataPath = Path.Combine(_webHostEnvironment.ContentRootPath, "Data", "enrollments.json");
            ...
            if (!File.Exists(_enrollmentDataPath))
            {
                File.WriteAllText(_enrollmentDataPath, "[]");
            }
        }
        ...
        public List<Enrollment> GetEnrollments()
        {
            ...
            var jsonString = File.ReadAllText(_enrollmentDataPath);
        ...
        public void SaveEnrollments(List<Enrollment> enrollments)
        {
            ...
            File.WriteAllText(_enrollmentDataPath, jsonString);
        }
    }
}
